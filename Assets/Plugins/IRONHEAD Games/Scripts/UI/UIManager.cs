...
public class UIManager : MonoBehaviour
{
    ...
    public void ActivatePanel(GameObject panelToBeActivated)
    {
        ...
        TaskTimer.CreateConditionalTask(.2f, () => { return MainUIPanel_Gameobject.transform.parent.gameObject.activeInHierarchy && panelToBeActivated.activeInHierarchy; }, (int intvl) =>
        {
            string panelNameToBeActivated = panelToBeActivated.name;
            MainUIPanel_Gameobject.transform.parent.gameObject.SetActive(true);
    ...
    public void Change_UIBackground(string mapName)
    {
        if (mapName == MultiplayerVRConstants.MAP_TYPE_VALUE_SCHOOL)
        {
            ...
            selectedMapType = MultiplayerVRConstants.MAP_TYPE_VALUE_PC;
