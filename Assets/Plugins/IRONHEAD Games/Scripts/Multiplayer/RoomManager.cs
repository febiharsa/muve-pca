...
namespace IRONHEADGames
{
    public class RoomManager : MonoBehaviourPunCallbacks
    {
        ...
        {
            mapType = MultiplayerVRConstants.MAP_TYPE_VALUE_PC;
        ...
        public override void OnJoinedRoom()
        {
            ...
            if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey(MultiplayerVRConstants.MAP_TYPE_KEY))
            {
                ...
                if (PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue(MultiplayerVRConstants.MAP_TYPE_KEY, out mapType))
                {
                    ...
                    else if ((string)mapType == MultiplayerVRConstants.MAP_TYPE_VALUE_PC)
                    {
                        //Load the PC Scene                  
                        DebugUIManager.instance.FinishDebugUIMessage();
                        SceneLoader.instance.LoadScene("World_PC", true);
                    }
                }
            }
        }
        ...
        public override void OnRoomListUpdate(List<RoomInfo> roomList)
        {
            ...
            foreach (RoomInfo room in roomList)
            {
                ...
                else if (room.Name.Contains(MultiplayerVRConstants.MAP_TYPE_VALUE_PC))
                {
                    //Update the School room map
                    Debug.Log("Room is a PC map. Player count is: " + room.PlayerCount);
        ...
        public void CreateDebugRoom(string roomName)
        {
            CreatePrivateRoom(roomName, 4, MultiplayerVRConstants.MAP_TYPE_VALUE_SCHOOL);
        }
